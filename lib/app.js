  ...
  return m.jsxs("section", {
    ...
    children: [
      ...
      m.jsx("div", {
        ...
        style: { borderTop: "1px dashed color-mix(in srgb, #ebe8db 12%, transparent)", display: "flex", overflow: "hidden" },
        children: [
          { val: "47m", lbl: "Tinggi Candi" },
          { val: "1991", lbl: "UNESCO WHS" },
          { val: "42", lbl: "Panel Relief" },
          { val: "7+", lbl: "Sensor Akuisisi" },
          { val: "100m", lbl: "Panjang Lorong" },
          { val: "Abad 9", lbl: "Masa Pendirian" },
        ].map((o, c, f) =>
          m.jsxs(
            "div",
            {
              style: { flex: 1, padding: "20px 16px", borderRight: c < f.length - 1 ? "1px dashed color-mix(in srgb, #ebe8db 10%, transparent)" : "none", textAlign: "center" },
              children: [
                m.jsx("div", { style: { fontFamily: "var(--font-heading-sans)", fontSize: 28, fontWeight: 500, letterSpacing: "-1px", color: "var(--bg-1)", lineHeight: 1 }, children: o.val }),
                m.jsx("div", { style: { fontFamily: "var(--font-ui)", fontSize: 9, letterSpacing: "1.2px", textTransform: "uppercase", color: "color-mix(in srgb, #ebe8db 30%, transparent)", marginTop: 4 }, children: o.lbl }),
              ],
            },
            o.lbl,
          ),
            ...
            children: [
              m.jsx("div", {
                ...
                children: m.jsxs("div", {
                  ...
                  children: [
                    m.jsxs("div", {
                      style: { position: "absolute", top: 20, left: 20, display: "flex", flexDirection: "column", gap: 4 },
                      children: [
                        m.jsx("div", { style: { fontFamily: "var(--font-ui)", fontSize: 9, letterSpacing: "1.5px", textTransform: "uppercase", color: "var(--dark-32)" }, children: "Tampak Depan" }),
                        m.jsx("div", { style: { fontFamily: "var(--font-ui)", fontSize: 9, letterSpacing: "1px", color: "var(--dark-16)" }, children: "Elevasi 1:350" }),
                      ],
                    }),
                    m.jsxs("div", {
                      style: { position: "absolute", top: 30, right: 18, display: "flex", flexDirection: "column", alignItems: "center", gap: 0 },
                      children: [
                        m.jsxs("div", {
                          style: { width: 1, height: 280, background: "var(--dark-16)", position: "relative" },
                          children: [
                            m.jsx("div", { style: { position: "absolute", top: 0, left: -3, width: 7, height: 1, background: "var(--dark-16)" } }),
                            m.jsx("div", { style: { position: "absolute", bottom: 0, left: -3, width: 7, height: 1, background: "var(--dark-16)" } }),
                          ],
                        }),
                        m.jsx("div", { style: { fontFamily: "var(--font-ui)", fontSize: 9, letterSpacing: "0.5px", color: "var(--dark-32)", writingMode: "horizontal-tb", marginTop: 4 }, children: "47 m" }),
                      ],
                    }),
                    ...
                    m.jsxs("div", {
                      style: {
                        ...
                        left: 20,
                        right: 20,
                        background: "rgba(235,232,219,0.88)",
                        ...
                        alignItems: "center",
                        gap: 12,
                        border: "1px solid rgba(42,33,25,0.08)",
                      },
                      children: [
                        m.jsx("div", { style: { width: 8, height: 8, borderRadius: "50%", background: "var(--yellow)", flexShrink: 0 } }),
                        m.jsxs("div", {
                          children: [
                            m.jsx("div", { style: { fontFamily: "var(--font-ui)", fontSize: 10, letterSpacing: "1.2px", textTransform: "uppercase", color: "var(--dark-32)", marginBottom: 2 }, children: "World Heritage Site" }),
                            m.jsx("div", { style: { fontFamily: "var(--font-body)", fontSize: 14, color: "var(--dark)", fontStyle: "italic" }, children: "UNESCO 1991 · Sleman, D.I. Yogyakarta" }),
                          ],
                        }),
                      ],
                    }),
        ...
        m.jsx("div", {
          ...
          children: X1.map((o, c) =>
            m.jsxs(
              "div",
              {
                style: { display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "24px 0 24px 24px", borderLeft: "1px dashed var(--dark)", minHeight: 220, marginTop: [0, 60, 120, 0, 60, 120, 0, 60][c], gap: 20 },
                children: [
                  m.jsxs("div", {
                    children: [
...
const o2 = [
  ...
  ce = [
    { id: "siwa", name: "Candi Siwa", sub: "Candi Utama · 47 m", tag: "VIRTUAL TOUR", main: !0, x: 420, y: 296, size: 64, innerSize: 38 },
    { id: "brahma", name: "Candi Brahma", sub: "Trimurti · Selatan", tag: null, main: !1, x: 420, y: 440, size: 44, innerSize: 26 },
    { id: "wisnu", name: "Candi Wisnu", sub: "Trimurti · Utara", tag: null, main: !1, x: 420, y: 152, size: 44, innerSize: 26 },
    { id: "nandi", name: "Candi Nandi", sub: "Wahana Siwa", tag: null, main: !1, x: 640, y: 296, size: 34, innerSize: 20 },
    { id: "garuda", name: "Candi Garuda", sub: "Wahana Wisnu", tag: null, main: !1, x: 640, y: 152, size: 28, innerSize: 16 },
    { id: "angsa", name: "Candi Angsa", sub: "Wahana Brahma", tag: null, main: !1, x: 640, y: 440, size: 28, innerSize: 16 },
  ];
          ...
          m.jsx("div", {
            ...
            children: o2.map((y, _) =>
              m.jsxs(
                "div",
                {
                  style: { display: "flex", flexDirection: "column", gap: 16, padding: "24px 0 24px 24px", borderLeft: "1px dashed var(--dark)", marginTop: [0, 40, 80][_] },
                  children: [
        ...
        children: [
          m.jsxs("svg", {
            ...
            children: [
              ...
              m.jsx("rect", { x: "30", y: "28", width: "1000", height: "524", rx: "4", fill: "#c2ad8a", stroke: "rgba(42,33,25,0.22)", strokeWidth: "1.5" }),
              m.jsx("rect", { x: "30", y: "28", width: "1000", height: "524", rx: "4", fill: "url(#mapgrid)" }),
              m.jsx("rect", { x: "80", y: "60", width: "900", height: "460", rx: "2", fill: "rgba(42,33,25,0.06)", stroke: "rgba(42,33,25,0.22)", strokeWidth: "1.5" }),
              m.jsx("rect", { x: "170", y: "100", width: "720", height: "380", rx: "2", fill: "rgba(42,33,25,0.05)", stroke: "rgba(42,33,25,0.18)", strokeWidth: "1.2" }),
              m.jsx("rect", { x: "255", y: "135", width: "550", height: "310", rx: "2", fill: "url(#paving)", stroke: "rgba(42,33,25,0.28)", strokeWidth: "1.5" }),
              Array.from({ length: 7 }).map((y, _) => m.jsx("line", { x1: "255", y1: 135 + ((_ + 1) * 310) / 8, x2: "805", y2: 135 + ((_ + 1) * 310) / 8, stroke: "rgba(42,33,25,0.06)", strokeWidth: "0.6" }, `h${_}`)),
              Array.from({ length: 12 }).map((y, _) => m.jsx("line", { x1: 255 + ((_ + 1) * 550) / 13, y1: "135", x2: 255 + ((_ + 1) * 550) / 13, y2: "445", stroke: "rgba(42,33,25,0.06)", strokeWidth: "0.6" }, `v${_}`)),
              ...
              m.jsxs("g", {
                transform: "translate(62, 530)",
                opacity: "0.45",
                children: [
                  m.jsx("line", { x1: "0", y1: "0", x2: "80", y2: "0", stroke: "#2a2119", strokeWidth: "1.5", strokeLinecap: "round" }),
                  m.jsx("line", { x1: "0", y1: "-4", x2: "0", y2: "4", stroke: "#2a2119", strokeWidth: "1.5" }),
                  m.jsx("line", { x1: "80", y1: "-4", x2: "80", y2: "4", stroke: "#2a2119", strokeWidth: "1.5" }),
                  m.jsx("text", { x: "40", y: "-8", fontFamily: "'DM Mono', monospace", fontSize: "9", fill: "#2a2119", textAnchor: "middle", letterSpacing: "0.5", children: "100 m" }),
                ],
              }),
              m.jsxs("g", {
              ...
              m.jsx("text", { x: "530", y: "554", fontFamily: "'DM Mono', monospace", fontSize: "9", fill: "rgba(42,33,25,0.25)", textAnchor: "middle", letterSpacing: "3", children: "SELATAN" }),
          ...
          g &&
            m.jsxs("div", {
              ...
              children: [
                m.jsx("div", { style: { fontFamily: "var(--font-ui)", fontSize: 9, letterSpacing: "1.2px", textTransform: "uppercase", color: "var(--dark-32)", marginBottom: 6 }, children: g.sub }),
                m.jsx("div", { style: { fontFamily: "var(--font-heading-sans)", fontSize: 18, fontWeight: 500, letterSpacing: "-0.5px", color: "var(--dark)", marginBottom: 4 }, children: g.name }),
                g.main && m.jsx("div", { style: { fontFamily: "var(--font-ui)", fontSize: 10, letterSpacing: "1px", textTransform: "uppercase", color: "var(--acc-3)", marginTop: 6 }, children: "▶ Virtual Tour Tersedia" }),
              ],
            }),
        ],
      }),
      ...
      m.jsxs("div", {
        ...
        children: [
          ...
          m.jsxs("div", {
            ...
            children: [
              m.jsx("div", { style: { fontFamily: "var(--font-ui)", fontSize: 10, letterSpacing: "0.5px", color: "var(--dark-64)" }, children: "© 2025 Proyek Akhir TSPD · Sekolah Vokasi UGM" }),
...
function M2() {
  return m.jsxs(B_, { children: [m.jsx(Wf, { path: "/", component: lg }), m.jsx(Wf, { path: "/index.html", component: lg }), m.jsx(Wf, { component: C2 })] });
}
function L2() {
